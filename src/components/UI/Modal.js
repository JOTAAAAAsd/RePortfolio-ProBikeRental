...
export const ModalConfirm = (props) => {
    ...
    // NOTA: Problemas con el storage (el día de renta y el total), lo voy a solucionar, pero no tengo tiempo para entregarlo, por lo que lo dejaré así.
    // console.log(useModalDataDetails);
